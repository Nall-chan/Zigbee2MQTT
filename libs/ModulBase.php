...
abstract class ModulBase extends \IPSModule
{
     ...
     */
    protected function AppendVariableTypes($Payload): array
    {
        ...
        if ($type === 'binary') {
            if (isset($expose['value_on']) && isset($expose['value_off'])) {
                ...
                if (($valueOn === true && $valueOff === false) ||
                    ...
                    return $this->registerCustomStringProfile($ProfileName, (string) $valueOn, (string) $valueOff);
                }
            }
            return '~Switch';
        }
